<template>
  <section
    class="rotor-setup is-flex is-flex is-flex-direction-row is-justify-content-space-evenly is-align-items-center"
  >
...
const rotor = ref(
  props.position === RotorPositions.LEFT ? Rotors.III : props.position === RotorPositions.MIDDLE ? Rotors.II : Rotors.I
)
const setting = ref('A')
